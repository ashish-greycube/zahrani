...
frappe.require("assets/erpnext/js/financial_statements.js", function() {
	frappe.query_reports["Profitability Analysis-Expense"] = {
		"filters": [
			{
				"fieldname": "company",
				"label": __("Company"),
		...
		"formatter": function(row, cell, value, columnDef, dataContext, default_formatter) {
			if (columnDef.df.fieldname=="account") {
				...
				columnDef.df.link_onclick =
					"frappe.query_reports['Profitability Analysis-Expense'].open_profit_and_loss_statement(" + JSON.stringify(dataContext) + ")";
